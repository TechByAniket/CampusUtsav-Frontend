...
import { 
  ...
  Calendar, ShieldCheck, User, Smartphone
} from 'lucide-react';
import type { 
...
export const RegistrationInfoList = ({ registrations, isTeamEvent }: RegistrationInfoListProps) => {
  ...
  }, [registrations.teams, searchQuery]);

  const filteredIndividuals = useMemo(() => {
    return registrations.individuals.filter(i => 
      i.student.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  }, [registrations.individuals, searchQuery]);
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <div className="relative group">
                ...
                <input 
                    ...
                    className="pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-full text-sm focus:outline-none w-full md:w-80 font-medium transition-all focus:border-indigo-300 shadow-sm" 
                    value={searchQuery}
                                        ...
                                        return (
                                            <tr key={reg.registrationId} className="hover:bg-indigo-50/40 transition-colors group">
                                                <td className="px-6 py-4">
                                                    ...
                                                    {activeTab === 'TEAM' && (
                                                        <div className="text-[12px] text-slate-400 font-bold uppercase tracking-tight mt-0.5 truncate max-w-[180px]">
                                                            Lead: {student.name}
                                                        </div>
                                                    )}
                                                </td>
