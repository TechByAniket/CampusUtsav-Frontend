      ...
      <main className="max-w-5xl mx-auto space-y-4 font-jakarta">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                <AtSign size={10} className="text-indigo-400" /> {profileData.email?.split('@')[0]}
              </p>
            </div>
          </div>

          <div className="flex flex-wrap items-start gap-8 md:pr-4">
             <HeroInfo label="Emp ID" value={profileData.employeeId} />
             <HeroInfo label="Phone" value={profileData.phone} verified={true} />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Tile 
            ...
            label="Branch"
            value={profileData.branchShortForm || profileData.branchName}
            color="blue"
          />
          ...
          <Tile 
            ...
            label="Designation"
            value={profileData.designation?.replace(/_/g, ' ')}
            color="violet"
          />
          ...
          <Tile 
            ...
            label={profileData.clubCoordinator ? "Club Management" : "Role Status"}
            value={profileData.managedClubDetails?.name || (profileData.hod ? "Department Head" : "Faculty Member")}
            color="emerald"
          />
          ...
          <Tile 
            icon={<Award size={16} />}
            label="System Role"
            value={profileData.userRole?.replace('ROLE_', '')}
            color="teal"
          />
        </div>
      </main>
